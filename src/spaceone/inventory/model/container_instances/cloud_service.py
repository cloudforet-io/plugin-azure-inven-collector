...
container_instances_info_meta = ItemDynamicLayout.set_fields('Container Instances', fields=[
    ...
    TextDyField.data_source('vCPU count', 'data.container_count_display'),
...
container_instances_info_container = TableDynamicLayout.set_fields('Containers', root_path='data.containers', fields=[
    ...
    DateTimeDyField.data_source('Start time', 'instance_view.current_state.start_time'),
    DateTimeDyField.data_source('Finish time', 'instance_view.current_state.finish'),
