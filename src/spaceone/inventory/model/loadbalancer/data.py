...
class VirtualNetworkTap(Model):
    ...
    location = StringType(serialize_when_none=False)
    name = StringType(serialize_when_none=False)
    destination_load_balancer_front_end_ip_configuration = ModelType(FrontendIPConfiguration,
                                                                     serialize_when_none=False)
    destination_network_interface_ip_configuration = ModelType(NetworkInterfaceIPConfiguration,
                                                               serialize_when_none=False)
...
class LoadBalancer(AzureCloudService):
    name = StringType()
    id = StringType()
    location = StringType()
